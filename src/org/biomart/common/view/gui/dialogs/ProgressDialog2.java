...
public class ProgressDialog2 extends JDialog {
	...
	private ProgressDialog2() {
		...
		content.add(this.statusLabel, fieldConstraints);
	...
	public void start(String statusMessage) {
		...
		timer.setInitialDelay(100); // Start immediately upon request.
			...
			public void actionPerformed(final ActionEvent e) {
				SwingUtilities.invokeLater(new Runnable() {
					public void run() {
						...
						if (ProgressDialog2.this.isVisible()) {
							ProgressDialog2.this.statusLabel.setText(ProgressDialog2.this.statusMessage);
							ProgressDialog2.this.pack();
						}
						else {
