...
public class MartServiceSchema extends DataSource {
	public SuperTable2 superTable2 = null;
	//public RestFul restFul = null;
	public MartServiceSchema(SuperTable2 superTable2) {
		this(superTable2, true, null, null);
	}
	public MartServiceSchema(SuperTable2 superTable2, boolean doBatch, String linkTableName, String linkTableKey) {
		super();
		this.superTable2 = superTable2;
