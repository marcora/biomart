 ...
 * @since 0.7
 */
public class BeanIterator<E> extends WeakPropertyChangeSupport implements Iterator<E> {
	 ...
	 */
	public BeanIterator(final Iterator<E> delegate) {
		super(delegate);
	 ...
	 *            the delegate iterator.
	 */
	public BeanIterator(final BeanIterator<E> delegate) {
		this(delegate.delegate);
