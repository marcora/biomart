...
public class DataSetContext extends SchemaContext {
	...
	public void customiseAppearance(final JComponent component,
		...
		if (object instanceof Relation) {
			...
			final Table ttarget =  relation.getManyKey()
					.getTable();
				if(ttarget instanceof DataSetTable) {
					DataSetTable target = (DataSetTable) ttarget;
				// Is it compounded?
	...
	public void populateContextMenu(final JPopupMenu contextMenu,
		...
		if (object instanceof DataSetTable) {
			...
			final JMenuItem explain = new JMenuItem(Resources
					.get("explainTableTitle"),McUtils.createImageIcon(Resources
							.get("HELPIMAGE")));
			explain
