...
public class KeyComponent extends BoxShapedComponent {
	...
	public KeyComponent(final Key key, final Diagram diagram) {
		...
		// Repaint events.
		key.addPropertyChangeListener(Resources.get("PCDIRECTMODIFIED"), this.repaintListener);
				...
				try {
					...
					if (data instanceof Key) {
						...
						if (!sourceKey.equals(targetKey)) {
							KeyComponent.this.getDiagram().getMart()
									.getSchemasObj().requestCreateRelation(
											sourceKey, targetKey);
