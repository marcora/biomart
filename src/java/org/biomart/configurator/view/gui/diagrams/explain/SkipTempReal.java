...
import org.biomart.configurator.view.gui.diagrams.explain.FakeTable;
import org.biomart.configurator.view.gui.diagrams.explain.RealisedRelation;
import org.biomart.configurator.view.gui.diagrams.explain.RealisedTable;

/**
 * This version of the class shows a temp table on the left and a real table
 * on the right.
 */
public class SkipTempReal extends ExplainTransformationDiagram {
	 ...
	 */
	public SkipTempReal(final Mart mart, final SkipTable ltu,
