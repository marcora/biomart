...
public class GetRootContainerRequest extends MartServiceRequest {
	
	protected String datasetName = null;
	protected String partitionFilter = null;
	protected List<String> partitionFilterValues = null;
	
	public GetRootContainerRequest(String username, String password, 
	...
	public GetRootContainerRequest(String username, String password, MartServiceFormat format, 
			String datasetName, String partitionFilter, List<String> partitionFilterValues) {
		this(null, null, null, null, username, password, format, datasetName, partitionFilter, partitionFilterValues);
	}
	public GetRootContainerRequest(String requestName, Namespace martServiceNamespace, Namespace xsiNamespace, String xsdFile,
